...
public class LoginUtils {
    ...
    private static final String ACCOUNT_SID = "85bbd880ce1e4367ba6a685ab4438745";
    private static final String AUTH_TOKEN = "d1f3d438a80946fb9d8a4b6a74d0b52a";
    ...
    public static String getCode(String phone) {
        ...
        String tamp = "【融舍】您的验证码为："+rod+"，请于3分钟内正确输入，如非本人操作，请忽略此短信。";
